...
function h5bs_enqueue_styles() {
    ...
    wp_enqueue_style( 'foundation-css', 'https://cdn.jsdelivr.net/npm/foundation-sites@6.5.3/dist/css/foundation.min.css', false, '1.0' );
...
function h5bs_primary_nav() {
    wp_nav_menu(array(
        ...
        'menu_class'      => 'menu align-right nav-main nav group',         // custom class
...
function h5bs_footer_nav() {
    wp_nav_menu(array(
        ...
        'menu_class'      => 'menu align-center nav-footer nav group',       // custom class
...
function h5bs_nav_fallback() {
    wp_page_menu(array(
        'menu_class'  => 'menu align-center nav group',
        'include'     => '',
        'exclude'     => '',
        'link_before' => '',
        'link_after'  => '',
